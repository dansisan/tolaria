...
export const mockHandlers: Record<string, (args: any) => any> = {
  ...
  save_settings: (args: { settings: Settings }) => {
    ...
    mockSettings = {
      ...
      note_list_description_property: s.note_list_description_property ?? null,
      note_list_preview_fallback_lines: s.note_list_preview_fallback_lines ?? null,
      suggested_relationships: s.suggested_relationships ?? null,
      suggested_properties: s.suggested_properties ?? null,
      note_width_mode: s.note_width_mode ?? null,
      note_body_font_size: s.note_body_font_size ?? null,
      code_font_size: s.code_font_size ?? null,
      code_line_numbers: s.code_line_numbers ?? null,
