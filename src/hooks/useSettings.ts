...
const EMPTY_SETTINGS: Settings = {
  ...
  writing_suggestions_enabled: null,
...
function normalizeSettings(settings: Settings): Settings {
  ...
  return {
    ...
    code_line_numbers: settings.code_line_numbers ?? null,
    writing_suggestions_enabled: settings.writing_suggestions_enabled ?? null,
