...
"#;
    ...
    let entry = parse_md_file(&dir.path().join("publish-essays.md"), "created").unwrap();
...
"#;
    ...
    let entry = parse_md_file(&dir.path().join("some-project.md"), "created").unwrap();
...
"#;
    ...
    let entry = parse_md_file(&dir.path().join("plain-note.md"), "created").unwrap();
...
"#;
    ...
    let entry = parse_md_file(&dir.path().join("single-vs-array.md"), "created").unwrap();
    assert_relationship_values(
        &entry.relationships,
        &[
            ("Mentor", &["[[person/bob|Bob Smith]]"]),
...
"#;
    ...
    let entry = parse_md_file(&dir.path().join("mixed-array.md"), "created").unwrap();
    assert_relationship_values(
        &entry.relationships,
...
"#;
    ...
    let entry = parse_md_file(&dir.path().join("no-code.md"), "created").unwrap();
